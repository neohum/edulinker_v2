...
[Run]
Filename: "powershell.exe"; Parameters: "-ExecutionPolicy Bypass -File ""{app}\install_deps.ps1"""; StatusMsg: "백엔드 구동 환경(Go, Redis, Minio 등)을 자동 설치 및 셋업하는 중입니다... (콘솔 창이 나타날 수 있습니다)"; Flags: waituntilterminated skipifsilent
